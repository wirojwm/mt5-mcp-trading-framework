#!/usr/bin/env python3
"""
Reconciles ticket 171651879 (grid SELL_LIMIT, magic=71101, Step 27's live loop run), found absent
...
this project (Steps 9, 15, 17, 20, 26, 27). Local StateStore still shows it as OPEN (stale, per
Step 24's already-traced-harmless finding), since no close_position()/cancel() call was ever made
for it by this project.
...
SYMBOL = "BTCUSD"
TICKET = 171651879  # grid SELL_LIMIT, confirmed absent from live state on a prior read-only check
