...
dry_run.py (DryRunExecutor) added in Phase 5, as promised in Phase 2's docstring here. The
demo executor, gated by require_demo_account and explicit approval, is still Phase 6 work.
"""
