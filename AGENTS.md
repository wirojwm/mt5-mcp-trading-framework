...
`docs/GRID_REGIME_FILTER_CHECKPOINT.md`, and Phase 9 (**Steps 1-6 done, Step 5 live-verified,
...
read whichever is relevant before continuing that work in a new session.
